  ...
  return (
    <div className='main p-16 w-[100%]'>
        ...
        <div className='flex lg:justify-end'>
            <div className='target mb-8 flex flex-col items-center p-6 rounded-lg mt-16 border-[1px] border-gray-400 shadow-lg shadow-slate-600 to-transparentbg-repeat-round lg:w-[60%]' style={{backdropFilter: "blur(6px)"}}>
        ...
        <div className='target mb-8 flex flex-col p-6 rounded-lg mt-16 border-[1px] bg-gradient-to-b from-slate-800 to-black border-gray-400 shadow-lg shadow-slate-600 to-transparentbg-repeat-round max-sm:w-[100%] lg:w-[60%]' style={{backdropFilter: "blur(6px)"}}>
